...
function DarkServer() {
    ...
    this.config = {
        ...
        foodMaxSize: 10,            // Maximum food size (vanilla 20)
        ...
        /** EJECTED MASS **/
        ejectSize: 37.4165,           // vanilla: mass = val*val/100 = 14 mass?
        ejectSizeLoss: 37.4165,       // Eject size which will be substracted from player cell (vanilla: mass = val*val/100 = 14 mass?)
        ...
        playerMaxSize: 150000,        // Maximum size a player cell can achive before auto-splitting. (vanilla: mass = val*val/100 = 22500 mass)
        ...
        playerRecombineTime: 15,    // Base time in seconds before a cell is allowed to recombine
...
DarkServer.prototype.updateLeaderboard = function() {
    ...
    this.darkMode.updateLB(this, this.leaderboard);
...
DarkServer.prototype.movePlayer = function(cell, client) {
...
// decay player cells
DarkServer.prototype.updateSizeDecay = function(cell) {
...
DarkServer.prototype.boostCell = function(cell) {
...
DarkServer.prototype.autoSplit = function(cell, client) {
...
DarkServer.prototype.checkCellCollision = function(cell, check) {
    ...
    return {
        ...
        p: p           // vector check - cell position
    };
};

// Checks if collision is rigid body collision
DarkServer.prototype.checkRigidCollision = function(m) {
...
DarkServer.prototype.resolveRigidCollision = function(m) {
    var r = m.cell._size + m.check._size; // radius sum of cell & check
    var push = Math.min((r - m.d) / m.d, r - m.d); // min extrusion force
    if (push <= 0) return; // No intersect do not apply extrusion force
...
DarkServer.prototype.resolveCollision = function(m) {
    var cell = m.cell;
    var check = m.check;
...
DarkServer.prototype.splitPlayerCell = function(client, parent, angle, mass) {
...
DarkServer.prototype.spawnCells = function() {
    var spawnCount = 0;
    if (this.nodesFood.length >= 5) {
        ...
        spawnCount = this.config.foodMinAmount * 0.618;
    }
...
DarkServer.prototype.willCollide = function(size, cell) {
...
DarkServer.prototype.intersects = function(cell, node, size) {
...
DarkServer.prototype.loadConfig = function() {
    var fileNameConfig = this.srcFiles + '/server.ini';
