...
Experimental.prototype.spawnMotherCell = function (darkServer) {
...
Experimental.prototype.onServerInit = function (darkServer) {
...
Experimental.prototype.onTick = function (darkServer) {
    // Mother Cell Spawning
    if (this.tickMotherSpawn >= this.motherSpawnInterval) {
        this.tickMotherSpawn = 0;
        this.spawnMotherCell(darkServer);
    } else {
